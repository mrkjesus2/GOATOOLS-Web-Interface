...
Goatools.SectionsFile = {
  getFile: function(sections) {
    var data = {
  ...
  updateFile: function() {
    console.log('This is being done by new code');
    var $editor = $('#editor');
    var sections = {};
    ...
    if($editor.children().length > 0) {
      ...
      this.getFile(JSON.stringify(sections));
    }
  }
}
/**
...
function sectionDropOver(ev, el) { // eslint-disable-line no-unused-vars
  ...
  Goatools.Editor.addUnsavedWarning();
